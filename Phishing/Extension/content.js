...
// Use the correct API to send the message to the background script
...
function showPopup(message, backgroundColor) {
    ...
    popup.style.zIndex = '10000'; // Make sure it's on top of other elements
...
// Listen for the message from background script
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    let message = "";
    let backgroundColor = "";

    if (request.prediction === 1) {
        message = "⚠️ Warning: WEBSITE IS PHISHED!";
        backgroundColor = 'red';
